...
import com.hmibrahimsarkar.smritilipi.ui.font.FontLoader

/**
 * Creates a Compose [FontFamily] safely loaded from assets via FontLoader cache.
 */
fun createAssetFontFamily(context: Context, assetFileName: String): FontFamily {
    return FontLoader.loadFontFamilyFromAsset(context, assetFileName)
}
