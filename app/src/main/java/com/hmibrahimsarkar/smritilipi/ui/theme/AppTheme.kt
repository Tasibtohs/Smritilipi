...
object AppThemes {
    // 1. স্মৃতিলিপি ক্লাসিক (Smritilipi Classic - Official Brand Theme)
    val SmritilipiClassic = AppThemeData(
        id = "smritilipi_classic",
        nameBn = "স্মৃতিলিপি ক্লাসিক",
        descriptionBn = "গাঢ় নেভি ব্লু ও খাঁটি সোনালি আভার প্রিমিয়াম ব্র্যান্ড থিম",
        isDark = true,
        darkColorScheme = darkColorScheme(
            primary = GoldAccent,
            onPrimary = Color(0xFF0A1628),
            primaryContainer = Color(0xFF0B1F3A),
            onPrimaryContainer = GoldLight,
            secondary = GoldLight,
            onSecondary = Color(0xFF0A1628),
            secondaryContainer = Color(0xFF11223E),
            ...
            surface = Color(0xFF11223E),
            onSurface = Color(0xFFF5F5F5),
            surfaceVariant = Color(0xFF182F52),
            onSurfaceVariant = Color(0xFF9E9EA8),
            outline = Color(0xFF203B64),
            outlineVariant = Color(0xFF152846)
        ),
        lightColorScheme = lightColorScheme(
            primary = Color(0xFF0B1F3A),
            onPrimary = Color.White,
            primaryContainer = Color(0xFFF4F0E6),
            onPrimaryContainer = Color(0xFF0B1F3A),
            secondary = Color(0xFFC9A857),
            onSecondary = Color(0xFF0B1F3A),
            secondaryContainer = Color(0xFFEFE8D8),
            onSecondaryContainer = Color(0xFFA88939),
            tertiary = SuccessGreen,
            onTertiary = Color.White,
            error = ErrorRed,
            onError = Color.White,
            ...
            surfaceVariant = Color(0xFFF4F0E6),
            onSurfaceVariant = Color(0xFF6B6B6B),
            outline = Color(0xFFE5DECE),
            outlineVariant = Color(0xFFEDE7DA)
        ),
        darkPreviewBg = Color(0xFF0A1628),
        darkPreviewCard = Color(0xFF11223E),
        darkPreviewPrimary = Color(0xFFC9A857),
        darkPreviewSecondary = Color(0xFFE2C87A),
        darkPreviewText = Color(0xFFF5F5F5),
        lightPreviewBg = Color(0xFFFDFBF6),
        lightPreviewCard = Color(0xFFFFFFFF),
        lightPreviewPrimary = Color(0xFF0B1F3A),
        lightPreviewSecondary = Color(0xFFC9A857),
        lightPreviewText = Color(0xFF1C1C1E)
    )

    // 2. সোনালি ক্লাসিক (Royal Gold)
