...
object AppThemes {
    ...
    val SmritilipiClassic = AppThemeData(
        ...
        darkColorScheme = darkColorScheme(
            ...
            primaryContainer = Color(0xFF152646),
            onPrimaryContainer = GoldLight,
            secondary = GoldLight,
            onSecondary = Color(0xFF050B18),
            secondaryContainer = Color(0xFF0D1B33),
            onSecondaryContainer = GoldPrimary,
            tertiary = GoldDark,
            onTertiary = Color.White,
            background = Color(0xFF050B18),
            onBackground = Color(0xFFF5F0E1),
            surface = Color(0xFF0D1B33),
            onSurface = Color(0xFFF5F0E1),
            surfaceVariant = Color(0xFF152646),
            onSurfaceVariant = Color(0xFFB0BBD0),
            outline = Color(0xFF1E3A68),
            outlineVariant = Color(0xFF122240)
        ),
        lightColorScheme = lightColorScheme(
            ...
            onTertiary = Color(0xFF0A1F44),
            background = Color(0xFFF4F6FA),
            onBackground = Color(0xFF0A1F44),
            surface = Color(0xFFFFFFFF),
            onSurface = Color(0xFF0A1F44),
            surfaceVariant = Color(0xFFE8EDF5),
            onSurfaceVariant = Color(0xFF425678),
            outline = Color(0xFFCBD5E1),
            outlineVariant = Color(0xFFE2E8F0)
        ),
        darkPreviewBg = Color(0xFF050B18),
        darkPreviewCard = Color(0xFF0D1B33),
        darkPreviewPrimary = Color(0xFFD4AF37),
        darkPreviewSecondary = Color(0xFFF0D584),
        darkPreviewText = Color(0xFFF5F0E1),
        lightPreviewBg = Color(0xFFF4F6FA),
        lightPreviewCard = Color(0xFFFFFFFF),
        lightPreviewPrimary = Color(0xFFB8860B),
        lightPreviewSecondary = Color(0xFF1B3A6B),
        lightPreviewText = Color(0xFF0A1F44)
    )
