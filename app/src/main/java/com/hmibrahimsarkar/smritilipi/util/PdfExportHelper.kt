package com.hmibrahimsarkar.smritilipi.util
...
object PdfExportHelper {
     ...
     * 1. User author name (e.g. "কাজী নজরুল ইসলাম"): "— লেখক: কাজী নজরুল ইসলাম"
     * 2. Empty author name: "" (Completely hidden)
     */
    fun formatAuthorSignature(authorName: String): String {
        ...
        return if (trimmed.startsWith("—")) {
            trimmed
        } else if (trimmed.startsWith("লেখক:") || trimmed.startsWith("লেখক :")) {
            "— $trimmed"
        } else {
            "— লেখক: $trimmed"
        }
                ...
                <div class="page-outer-frame">
                    <div class="page-inner-frame">
                        ...
                        <div class="page-top-header">
                            <span class="header-left">Smritilipi</span>
                            ...
                            <div class="column-slot cover-left-slot">
                                <div class="cover-card">
                                    <div class="cover-card-inner">
                                        ...
                                        <h1 class="cover-title">Smritilipi</h1>
                                        <div class="cover-subtitle">~ নোট ও স্মৃতিলিপি সংকলন ~</div>
                                        <div class="cover-divider">✦ ❦ ✦</div>
                                        <div class="cover-info">
                                            <div class="cover-info-label">নোট সংকলন (বুকলেট সংস্করণ)</div>
                                            <div class="cover-date">সংকলনের তারিখ: $exportDate</div>
                                            <div class="cover-count">মোট নোট: ${toBengaliNumerals(notes.size)} টি</div>
                                            ${if (formattedAuthorText.isNotBlank()) "<div class=\"cover-author\">${escapeHtml(formattedAuthorText)}</div>" else ""}
                                        </div>
                                        <div class="cover-footer-text">স্মৃতিলিপি নোটবুক</div>
                        ...
                        <div class="page-bottom-footer">
                            ...
                            <div class="footer-row">
                                <span class="footer-app-name">Smritilipi</span>
                                <span class="footer-page-num">— কভার পাতা —</span>
                                <span class="footer-app-name">নোট সংকলন</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="page-outer-frame">
                            <div class="page-inner-frame">
                                ...
                                <div class="page-bottom-footer">
                                    ...
                                    <div class="footer-row">
                                        <span class="footer-app-name">Smritilipi</span>
                                        <span class="footer-page-num">— একক নোট সংস্করণ —</span>
                                        <span class="footer-app-name">নোট প্রকাশনা</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="column-slot end-left-slot">
                                <div class="end-card">
                                    <div class="end-card-inner">
                                        ...
                                        <p class="end-text">Smritilipi দিয়ে তৈরি • নোট সংকলন</p>
